...
static const char *const yytname[] =
{
  ...
  "RETURN", "DIGIT", "VARIABLE", "EQUAL", "NEQUAL", "LEQUAL", "BEQUAL",
  "'+'", "'-'", "'*'", "'/'", "'<'", "'>'", "$accept", "program",
  "additive-expression", "addop", "term", "mulop", "factor", YY_NULLPTR
};
#endif
